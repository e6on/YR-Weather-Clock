 ...
 */
export const getFutureDateString = (baseDate, daysOffset, hour) => {
 ...
 */
export const calculateWindChill = (tempCelsius, windSpeedMs) => {
 ...
 */
export const fetchWithRetry = async (url, { maxRetries = 3, retryDelay = 1000, timeout = 8000, onRetry = () => { } } = {}) => {
